...
//  Local Functions
//-------------------------------------------------------------------------------------------------
inline void _HalDispIrqEnableIsr(HalDispIrqType_e enType, bool *pbEn)
{
    u16 u16Val, u16Msk;
    bool bEnable = *pbEn;
...
inline void _HalDispIrqGetFlag(HalDispIrqType_e enType, u32 *pu32Flag)
{
...
inline void _HalDispIrqClear(HalDispIrqType_e enType)
{
    u16 u16Val, u16Msk;
...
inline void _HalDispIrqSupportedInternalIsr(bool *pbSupported)
{
    *pbSupported = HAL_DISP_INTERNAL_ISR_SUPPORT;
}

inline void  _HalDispIrqGetInternalIsrDeviceIdx(u8 *pu8Id)
{
    *pu8Id = HAL_DISP_DEVICE_IRQ_INTERNAL_ISR_IDX;
}


inline void _HalDispIrqEnableInternalIsr(HalDispIrqType_e enType, bool *pbEn)
{
    u16 u16Val, u16Msk;
    bool bEnable = *pbEn;
    u16Val = 0;
...
inline void _HalDispIrqGetInternalFlag(HalDispIrqType_e enType, u32 *pu32Flag)
{
    u16 u16Val;
    //u16 u16IrqMsk;
    *pu32Flag = 0;
...
inline void _HalDispIrqClearInternal(HalDispIrqType_e enType)
{
    u16 u16Val, u16Msk;
...
inline void _HalDispIrqGetInternalIsrStatus(u32 *pu32Status)
{
    *pu32Status = gu32InternalIsrStatus;
}


inline void _HalDispIrqSupportedVgaHpdIsr(bool *pbSupported)
{
    *pbSupported = HAL_DISP_VGA_HPD_ISR_SUPPORT;
}

inline void  _HalDispIrqGetVgaHpdIsrDeviceIdx(u8 *pu8Id)
{
    *pu8Id = HAL_DISP_DEVICE_IRQ_VGA_HPD_ISR_IDX;
}


inline void _HalDispIrqEnableVgaHpdIsr(HalDispIrqType_e enType, bool *pbEn)
{
    u16 u16Val, u16Msk;
    bool bEnable = *pbEn;
    u16Val = 0;
...
inline void _HalDispIrqGetVgaHpdFlag(HalDispIrqType_e enType, u32 *pu32Flag)
{
    u16 u16Val;
    //u16 u16IrqMsk;
    *pu32Flag = 0;
...
inline void _HalDispIrqClearVgaHpd(HalDispIrqType_e enType)
{
    u16 u16Val, u16Msk;
...
inline void _HalDispIrqGetVgaHpdIsrStatus(u32 *pu32Status)
{
