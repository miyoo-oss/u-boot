...
#ifndef __eMMC_CEDRIC_UBOOT__
#define __eMMC_CEDRIC_UBOOT__
...
*/
#define BIT_FCIE_CLK_MASK          ((BIT7-1)<<8)
#define BIT_FCIE_CLK_24M           ((0<<2)<<8)
#define BIT_FCIE_CLK_12M           ((1<<2)<<8)
#define BIT_FCIE_CLK_48M           ((2<<2)<<8)
#define BIT_FCIE_CLK_86M           ((3<<2)<<8)
#define BIT_FCIE_CLK_108M          ((4<<2)<<8)
#define BIT_FCIE_CLK_123M          ((5<<2)<<8)
#define BIT_FCIE_CLK_144M          ((6<<2)<<8)
#define BIT_FCIE_CLK_172M          ((7<<2)<<8)
#define BIT_FCIE_CLK_192M          ((8<<2)<<8)
#define BIT_FCIE_CLK_216M          ((9<<2)<<8)
#define BIT_FCIE_CLK_240M          ((10<<2)<<8)
#define BIT_FCIE_CLK_345M          ((11<<2)<<8)
#define BIT_FCIE_CLK_432M          ((13<<2)<<8)
#define BIT_FCIE_CLK_1200K         ((14<<2)<<8)
#define BIT_FCIE_CLK_300K          ((15<<2)<<8)
#define BIT_FCIE_CLK_32M           ((16<<2)<<8)
#define BIT_FCIE_CLK_36M           ((17<<2)<<8)
#define BIT_FCIE_CLK_40M           ((18<<2)<<8)
#define BIT_FCIE_CLK_43_2M         ((19<<2)<<8)
#define BIT_FCIE_CLK_54M           ((20<<2)<<8)
#define BIT_FCIE_CLK_62M           ((21<<2)<<8)
#define BIT_FCIE_CLK_72M           ((22<<2)<<8)
#define BIT_FCIE_CLK_80M           ((23<<2)<<8)

#define eMMC_FCIE_VALID_CLK_CNT         10
...
#define REG_CLK_EMMC			GET_REG_ADDR(RIU_BASE_CLKGEN0, 0x19)
#define REG_EMMC_MODE  GET_REG_ADDR(RIU_BASE_CHIPGPIO1, 0x10)
#define REG_ALL_PAD_IN  	 GET_REG_ADDR(RIU_BASE_CHIPGPIO1, 0x00)
#define REG_BPS_MODE   GET_REG_ADDR(RIU_BASE_CHIPGPIO1, 0x14)
#define eMMC_REG_CLK_4X_DIV_EN		    GET_REG_ADDR(RIU_BASE_CHIPTOP, 0x0E)
...
// set FCIE clock
//=====================================================
#define FCIE_SLOWEST_CLK                BIT_FCIE_CLK_1200K	//BIT_FCIE_CLK_300K
#define FCIE_SLOW_CLK                   BIT_FCIE_CLK_86M		//BIT_FCIE_CLK_24M
#define FCIE_DEFAULT_CLK                BIT_FCIE_CLK_144M		//BIT_FCIE_CLK_36M
