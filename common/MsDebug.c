...
//  Public Functions
//-------------------------------------------------------------------------------------------------
int do_set_debugging_message_level(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
int do_initDebugLevel(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
     if(argc!=1)
     {
        printf ("Usage:\n%s\n", cmdtp->usage);
