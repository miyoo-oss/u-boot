...
int do_mstar (struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    char* buffer=NULL;
...
int do_cis(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    U32 nand_info=0;
    U32 part_info=0;
    U8 *cis_info=NULL;
...
int do_readcisblk(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    void *addr;
...
int do_checkbackup(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
int do_emmc_cis(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    U32 part_info=0;
    U8 *cis_info=NULL;
    int result=0;
...
int do_verifyimg(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    image_header_t    *hdr;
    ulong        img_addr;
...
int do_setclk(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    if(argc != 2)
    {
        return  CMD_RET_USAGE;
